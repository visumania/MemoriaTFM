...
\begin{sugerencia}
Redacta este apartado con tus propias palabras. Es una forma de empezar con un texto antes de pasar a la primera sección, que será la "Motivación".
\end{sugerencia}

\textit{Ejemplo: Este primer capítulo sirve de introducción y brinda una base general del proyecto. En primer lugar, se describe la motivación por la cual se ha decidido llevar a cabo este trabajo, los objetivos propuestos y las competencias que se pretenden adquirir. Finalmente se describe la estructura del documento.}
