...
En la \autoref{fig:ResultadosTransformersPerspectivismoHombreDiscard} y en la \autoref{fig:ResultadosTransformersPerspectivismoMujerDiscard} descartamos los casos donde el modelo base no tiene un alto grado de confianza, se evaluó pureza de cada género ante los casos restantes:
\begin{itemize}
...
Los resultados de ambas aproximaciones permiten extraer varias conclusiones sobre el modelado y el género en el PLN.
