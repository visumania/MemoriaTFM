...
Al descartar los casos donde el modelo base no tiene un alto grado de confianza, evaluamos pureza de cada género ante los casos restantes:
\begin{itemize}
...
Al forzar al modelo a penalizar en caso de duda, los resultados se invierten y revelan el mejor escenario para el perfil femenino:
\begin{itemize}
...
En esta estrategia, donde el modelo asume que no hay machismo en caso de duda, se observa una clara diferencia en el comportamiento de ambos perfiles:
\begin{itemize}
...
Esta es posiblemente la estrategia más interesante desde el punto de vista del comportamiento algorítmico, ya que produce una similitud en ambos perfiles. 
\begin{itemize}
