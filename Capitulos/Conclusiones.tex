...
La experimentación ha demostrado que el sexismo es un fenómeno multimodal. Ningún modelo unimodal logró igualar el rendimiento del sistema unificado mediante \textit{Late Fusion}, el cuál alcanzó un \textit{F1-Score} de 0.7261 al ser evaluado sobre la partición de \textit{Test} de desarrollo local derivada el conjunto de entrenamiento. El análisis detallado demostró que el texto es dominante para detectar la carga ideológica, mientras que el análisis temporal del vídeo es de gran utilidad para capturar fenómenos visuales complejos como la cosificación. 
