...
En este apartado se detalla el tiempo y los recursos empleados en la investigación y redacción del presente Trabajo de Fin de Máster. Dada la magnitud de la experimentación requerida, el mayor esfuerzo no recayó en las entregas iniciales del reto, sino en el análisis avanzado, entrenamiento y depuración de modelos a posteriori. Las horas globales estimadas se resumen en la \autoref{tab:PlanificationTemporal}.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{Xr}
        ...
        \quad - Redacción, maquetación en \LaTeX{} y revisión final. & \\
        \midrule
