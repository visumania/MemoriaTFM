...
\begin{itemize}
    ...
    \item \textbf{\textit{Google Colab Pro} y \textit{Jupyter Notebook}}: Como entorno de desarrollo interactivo se han utilizado cuadernos de \textit{Jupyter} a través de la plataforma \textit{Google Colab}. En concreto, se ha hecho uso de recursos avanzados (acelerados de hardware como las \textit{GPU NVIDIA L4}) para llevar a cabo el entrenamiento de modelos masivos. En total se han consumido unas 300 unidades informáticas. 
...
A modo de conclusión, en este capítulo se han establecido los fundamentos teóricos necesarios para comprender los enfoques tecnológicos implementados a lo largo del proyecto. Esta base conceptual resulta indispensable para justificar las decisiones técnicas, algorítmicas y metodológicas que se abordará en detalle en el próximo capítulo. 