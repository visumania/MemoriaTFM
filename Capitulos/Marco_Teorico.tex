...
Por otro lado, para abordar la tarea de clasificación multietiqueta (donde un mismo registro puede presentar varias categorías de sexismo simultáneamente), el problema se modela habitualmente como un conjunto de decisiones binarias independientes. Aunque la entropía cruzada categórica tradicional no es aplicable de forma directa al no tratarse de clases mutuamente excluyentes, la familia de pérdidas de entropía cruzada sigue siendo el pilar fundamental a través de la \textbf{Entropía Cruzada Binaria} (\textit{Binary Cross-Entropy} o \textit{BCE}). Esta variante aplica los principios de la entropía cruzada para evaluar la probabilidad de presencia o ausencia de cada etiqueta de manera independiente, permitiendo que el modelo determine si una categoría específica aplica o no a la entrada, sin que dicha decisión restrinja las probabilidades del resto de etiquetas \cite{nam2014large}.
